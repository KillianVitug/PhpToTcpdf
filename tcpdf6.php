...
<table border="1" cellpadding="20" cellspacing="10" align="center">
 ...
 <tr nobr="true" >
  <td width="120" style="background-color:green;color:yellow;"><FONT COLOR="#ffffff">1<br />New Year's Day</FONT></td>
  <td width="120" style="background-color:green;color:yellow;"><FONT COLOR="#ffffff">2<br />(Special non-working day)</FONT></td>
  <td width="120">3</td>
  <td width="120">4</td>
  <td width="120">5</td>
  <td width="120">6</td>
